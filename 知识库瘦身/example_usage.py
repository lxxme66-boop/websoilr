...
import json
from optimized_deduplication import DocumentDeduplicator
...
sample_data = [
    {
        ...
        "Abstract": "本文探讨了深度学习技术在自然语言处理领域的最新应用，包括文本分类、情感分析和机器翻译等方面。"
    },
    {
        "doc_id": "002",
        "论文标题": "深度学习在NLP中的应用研究",
    ...
    },
    {
        "doc_id": "005",
        "论文标题": "计算机视觉技术发展",
        "Abstract": "计算机视觉是人工智能的重要分支，本文介绍了计算机视觉的发展历程和最新技术进展。"
    }
]
